...
class SpecViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        zeroHzLabel.center = CGPoint(x: labelContainer.frame.minX+4, y: labelContainer.frame.maxY-64)
        ...
        twentykHzLabel.center = CGPoint(x: labelContainer.frame.minX+4, y: labelContainer.frame.minY+19)
        ...
        yaxisLabel.center = CGPoint(x: labelContainer.frame.minX+4, y: labelContainer.frame.midY-25)
