...
public class FAQConfiguration {
  ...
  func defaultValue() {
    self.questionTextColor = UIColor.white
    self.answerTextColor = UIColor.white
    ...
    self.titleLabelBackgroundColor = UIColor.secondarySystemFill
    ...
    self.cellBackgroundColor = UIColor.secondarySystemFill
